...
*/
///storage/xmi/GerParCorDownload/Germany/National/Bundestag/15
//
        importMethod("/storage/xmi/GerParCorDownload/Germany/National/Bundestag/15", "xmi.gz", "Germany", "Bundestag", "National", "false", "15", "");
        importMethod("/storage/xmi/GerParCorDownload/Germany/National/Bundestag/20", "xmi.gz", "Germany", "Bundestag", "National", "false", "20", "");
...
*/
	            for (String s : "Oberoestereich".split(";")) {
			                importMethod("/storage/xmi/GerParCorDownload/Austria/Regional/"+s, "xmi.gz", "Austria", s, "Regional", "false", "", "");
					        }
...
//        this(folder, ending, debugCount, iRandom, bSort, savePath, bAddMetadata, language, 0);
        ...
        composer.add(new DUUIUIMADriver.Component(createEngineDescription(MongoDBImporter.class,
                MongoDBImporter.PARAM_DBConnection, "/resources/public/abrami/GerParCor/Java/src/main/resources/rw",
